...
public class Log {
     ...
     */
    public static final String  PROPERTY_LOGLEVEL = "ess/loglevel";
    ...
    private Log() {
        ...
        try {
            ...
            System.out.println("ESS: Log: Setting CurrentLoglevel to " + LoglevelString);
        } catch (NumberFormatException e) {
            CurrentLogLevel = LOGLEVEL_WARN;
            System.out.println("ESS: Log: Malformed loglevel, setting to WARN. " + e.getMessage());
        }
    }
    ...
    public void SetLogLevel(Integer NewLevel) {
        ...
        if (NewLevel<LOGLEVEL_ALL || NewLevel>LOGLEVEL_NONE) {
            System.out.println("ESS: Invalid new loglevel, setting loglevel to default.");
        ...
        switch (NewLevel) {
            case LOGLEVEL_NONE:     System.out.println("ESS: Setting loglevel to None.");   break;
            case LOGLEVEL_ERROR:    System.out.println("ESS: Setting loglevel to Error.");  break;
            case LOGLEVEL_WARN:     System.out.println("ESS: Setting loglevel to Warn.");   break;
            case LOGLEVEL_TRACE:    System.out.println("ESS: Setting loglevel to Trace.");  break;
            case LOGLEVEL_VERBOSE:  System.out.println("ESS: Setting loglevel to Verbose.");break;
            case LOGLEVEL_ALL:      System.out.println("ESS: Setting loglevel to All.");    break;
        }
    }
