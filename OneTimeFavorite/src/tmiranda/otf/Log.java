...
public class Log {
     ...
     */
    private static String PREFIX = "OTF: ";
     ...
     */
    private Log() {
        String LoglevelString = Configuration.GetServerProperty(Plugin.PROPERTY_LOGLEVEL, DEFAULT_LOGLEVEL);

        try {
            CurrentLogLevel = Integer.parseInt(LoglevelString);
            System.out.println(PREFIX + "Log: Setting CurrentLoglevel to " + LoglevelString);
        } catch (NumberFormatException e) {
            CurrentLogLevel = LOGLEVEL_WARN;
            System.out.println(PREFIX + "Log: Malformed loglevel, setting to WARN. " + e.getMessage());
        }
    }
    ...
    public void SetLogLevel(Integer NewLevel) {
        ...
        if (NewLevel<LOGLEVEL_MAX || NewLevel>LOGLEVEL_NONE) {
            System.out.println(PREFIX + "Invalid new loglevel, setting loglevel to default.");
            Configuration.SetServerProperty(Plugin.PROPERTY_LOGLEVEL, DEFAULT_LOGLEVEL);
            return;
        }
        ...
        switch (NewLevel) {
            case LOGLEVEL_NONE:     System.out.println(PREFIX + "Setting loglevel to None.");   break;
            case LOGLEVEL_ERROR:    System.out.println(PREFIX + "Setting loglevel to Error.");  break;
            case LOGLEVEL_WARN:     System.out.println(PREFIX + "Setting loglevel to Warn.");   break;
            case LOGLEVEL_TRACE:    System.out.println(PREFIX + "Setting loglevel to Trace.");  break;
            case LOGLEVEL_VERBOSE:  System.out.println(PREFIX + "Setting loglevel to Verbose.");break;
            case LOGLEVEL_MAX:      System.out.println(PREFIX + "Setting loglevel to Max.");    break;
        }
    }
